...
class ResultTransferencia extends StatefulWidget {
  const ResultTransferencia({Key? key, required this.idSede, required this.idDestino}) : super(key: key);
  final String idSede;
  final String idDestino;

  @override
  State<ResultTransferencia> createState() => _ResultTransferenciaState();
}

class _ResultTransferenciaState extends State<ResultTransferencia> {
  final _documentoController = TextEditingController();
  final _personaController = TextEditingController();
  final _dniController = TextEditingController();
  final _recursoController = TextEditingController();
  final _controller = ResultTransferenciaController();
  @override
                    ...
                    Navigator.push(
                      ...
                      PageRouteBuilder(
                        ...
                        pageBuilder: (context, animation, secondaryAnimation) {
                          return Confirmar(
                              idSede: widget.idSede,
                              idAlmacenDestino: widget.idDestino,
                              tipoRegistro: '0',
        ...
        return InkWell(
          ...
          child: Column(
            children: [
              ...
              fileData('Orden de ResultTransferencia', 'Ver', 10, 14, FontWeight.w500, FontWeight.w600, TextAlign.start),
              Divider(),
            ],
          ),
        );
      ...
      showDialog(
        ...
        builder: (_) {
          return AlertDialog(
            ...
            content: SizedBox(
              height: ScreenUtil().setHeight(60) * (res.length + 2),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text(
                    'Este item se encuentra pendiente de salida en las siguientes ordenes:',
...
class ResultTransferenciaController extends ChangeNotifier {
