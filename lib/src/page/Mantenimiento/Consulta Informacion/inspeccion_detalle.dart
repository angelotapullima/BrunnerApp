...
class InspeccionDetalle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    inspeccionBloc.getDetalleInspeccionDetalle(inspeccion.idInspeccionVehiculo.toString(), inspeccion.tipoUnidad.toString());
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Detalle CheckList',
      ...
      body: StreamBuilder<List<InspeccionVehiculoModel>>(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            '${obtenerFecha(inspeccion.fechaInspeccionVehiculo.toString())} ${inspeccion.horaInspeccionVehiculo}',
                            style: TextStyle(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            (inspeccion.tipoUnidad == '1') ? 'Kilometraje' : 'Horometraje',
            style: TextStyle(
              color: Colors.blueGrey,
              fontSize: ScreenUtil().setSp(16),
              fontWeight: FontWeight.w500,
          ...
          TextField(
            ...
            decoration: InputDecoration(
              suffix: Text(
                (inspeccion.tipoUnidad == '1') ? 'KM' : 'Horas',
